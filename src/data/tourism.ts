export const tourismContent = {
  ...
  zh: {
    ...
    items: [
      ...
      { id: 'hana', name: '哈纳公路', location: '茂宜岛', category: '风景', rating: 4.7, img: 'https://images.unsplash.com/photo-1542085977-7b8f5bf1e49a?w=800&auto=format&fit=crop&q=80', description: '传奇的64英里公路，620个弯道，59座桥梁，穿越雨林瀑布、竹林和黑沙滩。旅途本身就是目的地。' },
